...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    } elseif(!preg_match('/^[a-zA-Z\s]+$/', $_POST["miast"])){
    ...
    } elseif(!preg_match('/^[a-zA-Z\s]+$/', $_POST["miejscowosc"])){
    ...
    } elseif(!preg_match('/^[a-zA-Z\s]+$/', $_POST["wojewodztwo"])){
...
} elseif(!preg_match('/^[a-zA-Z\s]+$/', $_POST["ulica"])){
