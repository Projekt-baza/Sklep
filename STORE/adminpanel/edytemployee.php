      ...
      <!--Logo-->
        ...
        <!-- Navbar left-->
            ...
            <div id="layoutSidenav_content">
             ...
             <!-- ZAWARTOSC----------------------------------------------------------------------------------------------------->
             <br><button><a class="btn btn-primary" href="editemployee.php" >Wroc</a></button></br>
             <?php
        require "connect.php";
        ...
        if(isset($_POST['execute'])) {
            ...
            $imie=$row['imie'];
            $rodzaj_pracownika=$row['rodzaj_pracownika'];
?>
        <form action="edytemployee.php" method="post">
