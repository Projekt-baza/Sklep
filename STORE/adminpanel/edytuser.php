    ...
    <body class="sb-nav-fixed">
      ...
      <!--Logo-->
        ...
        if(isset($_POST['execute'])) {
            ...
            $imie=$row['imie'];
            $token=$row['token'];
            $potwierdz=$row['potwierdz'];

?>
        <form action="edytuser.php" method="post">
            ...
            token: <input type="text" name="token" value="<?php echo $token; ?>" class="form-control"><br>
            potwierdz: <input type="number" name="potwierdz" value="<?php echo $potwierdz; ?>" class="form-control"><br>
...
<?php
    ...
    if(isset($_POST["id_adres"])){
        ...
        $_POST["nazwisko"].'", imie="'.
        $_POST["imie"].'", token="'.
        $_POST["token"].'", potwierdz="'
        .$_POST["potwierdz"].
        '" WHERE id_klient='.$_POST["id_klient"];
        $st=$pdo->query($query);
