                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="shadow-lg border-login mt-5">
                                    ...
                                    <form action="dodaddress.php" method="POST" class="dod">
                                      <label>Miasto</label>
                                      ...
                                      <input type="text" name="wojewodztwo" class="form-control">
                                      <label>Kod-pocztowy</label>
                                      <input type="text" name="kod_pocztowy" class="form-control">
                                      <label>Cena ulica</label>
                                      <input type="text" name="ulica" class="form-control">
                                      <label>Nr domu</label>
                                      <input type="number" name="nr_domu" class="form-control">
                                      <label>Nr mieszkania</label>
                                      <input type="number" name="nr_mieszkania" class="form-control">
